...
from integrated.sequential import all_filtering, integrated_filtering, all_smoothing, integrated_smoothing
...
# plt.plot(range(l-1, len(x) - 1, l), sequential_smoothed_slow.mean[1:, 0], '*--', color='g', label='sequential smoothed x - slow')
